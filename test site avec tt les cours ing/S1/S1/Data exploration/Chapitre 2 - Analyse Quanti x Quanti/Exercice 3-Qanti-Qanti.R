...
Dataset=read.table("DepensesEduData.csv",header=T, row.names=1,sep=';',dec=',') # Attention : la virgule
...
attributes(modele) # Donne tous les informations donn? par (modele), comme coefficients, residuals,....
