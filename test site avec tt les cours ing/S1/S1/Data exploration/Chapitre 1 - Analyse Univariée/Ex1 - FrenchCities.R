...
#*****************************Generalit?-Introduction***************************
  ...
  # 1. Selectionner un repertoire de travail (ouvrir le dossier ou se touve les donnés)
...
quantile(Dataset$NO2) # Donne tous les quantiles de la variable.
...
# POur calculer un quantile pr?cise 
 ...
 Dataset$NO2 +10 # Pour ajouter 10 ? chaque composante de NO2.
  ...
  pie(Effectif,main='Diagramme circulaire',col=heat.colors(4))
